export function sectionProducts() {
    return `
        <section class="px-4 sm:p-10 mb-12 sm:mb-20 products">
            <h2 class="text-3xl mb-2 sm:text-4xl font-bold text-coral-red sm:mb-4">Nuestros Helados</h2>
            
            <p class="mb-4">Cada bocado, un reflejo de amor. Cada helado, la pureza de la fruta natural.</p>
